...
#if !defined (__GNUC__)
#include <crtdbg.h>     // needed for ASSERT below
#endif
...
#define cbMAXOPEN   4           // Maximum number of open libraries
#define cbMAXPROCS  1
#define cbMAXBANKS  16
#define cbMAXGROUPS 8
...
#define cbMAXSITES  4     // maximum number of electrodes that can be included in an n-trode group
#define cbMAXSITEPLOTS ((cbMAXSITES - 1) * cbMAXSITES / 2)  // combination of 2 out of n is n!/((n-2)!2!)
...
#if defined (_MSC_VER) || defined (QT_APP)
// Open multiple instances of library as stand-alone or under given application
cbRESULT cbOpen(BOOL bStandAlone, LPCSTR lpName, UINT32 nNSPnum);
cbRESULT cbOpen(BOOL bStandAlone, LPCSTR lpName); // Open library as stand-alone or under given application
cbRESULT cbOpen(BOOL bStandAlone);                // Open library as stand-alone or under Central
#endif
cbRESULT cbOpen(void); // Open library under Central
...
#if defined (_MSC_VER) || defined (QT_APP)
cbRESULT cbClose(BOOL bStandAlone);
#endif
cbRESULT cbClose(void);
...
cbRESULT cbGetInstInfo(UINT32 *instInfo);
...
cbRESULT cbMakePacketReadingBeginNow(void);
...
cbRESULT cbGetProcInfo( UINT32 proc, cbPROCINFO *procinfo );
...
cbRESULT cbGetBankInfo( UINT32 proc, UINT32 bank, cbBANKINFO *bankinfo );
...
cbRESULT cbGetChanCount( UINT32 *count);
...
cbRESULT cbGetSystemRunLevel( UINT32 *runlevel, UINT32 *locked, UINT32 *resetque );
cbRESULT cbSetSystemRunLevel( UINT32 runlevel, UINT32 locked, UINT32 resetque );
// Get Set the System Condition
// Returns: cbRESULT_OK if data successfully retrieved.
//          cbRESULT_NOLIBRARY if the library was not properly initialized


cbRESULT cbGetSystemClockFreq( UINT32 *freq );
...
cbRESULT cbGetSystemClockTime( UINT32 *time );
...
cbRESULT cbGetSpikeLength(UINT32 *length, UINT32 *pretrig, UINT32 * pSysfreq);
cbRESULT cbSetSpikeLength(UINT32 length, UINT32 pretrig);
...
cbRESULT cbSetComment(UINT8 charset, UINT8 flags, UINT32 data, const char * comment);
// Set one comment event.
//
// Returns: cbRESULT_OK if data successfully retrieved.
//          cbRESULT_NOLIBRARY if the library was not properly initialized.

cbRESULT cbGetLncParameters(UINT32 *nLncFreq, UINT32 *nLncRefChan, UINT32 *nLncGMode);
cbRESULT cbSetLncParameters(UINT32 nLncFreq, UINT32 nLncRefChan, UINT32 nLncGMode);
// Get/Set the system-wide LNC parameters.
//
// Returns: cbRESULT_OK if data successfully retrieved.
//          cbRESULT_NOLIBRARY if the library was not properly initialized.

cbRESULT cbGetNplay(char *fname, float *speed, UINT32 *flags, UINT32 *ftime, UINT32 *stime, UINT32 *etime, UINT32 * filever);
cbRESULT cbSetNplay(const char *fname, float speed, UINT32 mode, UINT32 val, UINT32 stime, UINT32 etime);
...
cbRESULT cbGetVideoSource(char *name, float *fps, UINT32 id);
cbRESULT cbSetVideoSource(const char *name, float fps, UINT32 id);
...
cbRESULT cbGetTrackObj(char *name, UINT16 *type, UINT16 *pointCount, UINT32 id);
cbRESULT cbSetTrackObj(const char *name, UINT16 type, UINT16 pointCount, UINT32 id);
...
cbRESULT cbGetFilterDesc( UINT32 proc, UINT32 filt, cbFILTDESC *filtdesc );
...
cbRESULT cbGetSampleGroupInfo( UINT32 proc, UINT32 group, char *label, UINT32 *period, UINT32 *length );
cbRESULT cbGetSampleGroupList( UINT32 proc, UINT32 group, UINT32 *length, UINT32 *list );
cbRESULT cbSetSampleGroupOptions( UINT32 proc, UINT32 group, UINT32 period, char *label );
...
cbRESULT cbGetRawGroupInfo( UINT32 proc, UINT32 group, char *label, UINT32 *period, UINT32* length);
cbRESULT cbGetRawGroupList( UINT32 proc, UINT32 group, UINT32 *length, UINT32 *list);
...
cbRESULT cbGetChanCaps( UINT32 chan, UINT32 *chancaps );
...
cbRESULT cbGetChanLoc( UINT32 chan, UINT32 *proc, UINT32 *bank, char *banklabel, UINT32 *term );
...
cbRESULT cbGetChanLabel( UINT32 chan, char *label, UINT32 *userflags, INT32 *position);
cbRESULT cbSetChanLabel( UINT32 chan, const char *label, UINT32 userflags,  INT32 *position);
...
cbRESULT cbGetChanNTrodeGroup( UINT32 chan, UINT32 *NTrodeGroup);
cbRESULT cbSetChanNTrodeGroup( UINT32 chan, const UINT32 NTrodeGroup);
...
cbRESULT cbGetChanAmplitudeReject( UINT32 chan, cbAMPLITUDEREJECT *AmplitudeReject );
cbRESULT cbSetChanAmplitudeReject( UINT32 chan, const cbAMPLITUDEREJECT AmplitudeReject );
...
cbRESULT cbGetChanAutoThreshold( UINT32 chan, UINT32 *bEnabled );
cbRESULT cbSetChanAutoThreshold( UINT32 chan, const UINT32 bEnabled );
...
cbRESULT cbGetChanUnitMapping( UINT32 chan, cbMANUALUNITMAPPING *unitmapping);
cbRESULT cbSetChanUnitMapping( UINT32 chan, cbMANUALUNITMAPPING *unitmapping);
...
cbRESULT cbGetDinpCaps( UINT32 chan, UINT32 *dinpcaps );
...
cbRESULT cbGetDinpOptions( UINT32 chan, UINT32 *options, UINT32 *eopchar );
cbRESULT cbSetDinpOptions( UINT32 chan, UINT32 options, UINT32 eopchar );
...
cbRESULT cbGetDoutCaps( UINT32 chan, UINT32 *doutcaps );
...
cbRESULT cbGetAinpCaps( UINT32 chan, UINT32 *ainpcaps, cbSCALING *physcalin, cbFILTDESC *phyfiltin );
...
cbRESULT cbGetAinpOpts( UINT32 chan, UINT32 *ainpopts, UINT32 *LNCrate, UINT32 *refElecChan );
cbRESULT cbSetAinpOpts( UINT32 chan, const UINT32 ainpopts,  UINT32 LNCrate, const UINT32 refElecChan );
// Get and Set the user-assigned amplitude reject values.
//
// Returns: cbRESULT_OK if data successfully retreived or packet successfully queued to be sent.
//          cbRESULT_INVALIDCHANNEL if the specified channel is not mapped or does not exist.
...
cbRESULT cbGetAinpScaling(UINT32 chan, cbSCALING *scaling);
cbRESULT cbSetAinpScaling(UINT32 chan, cbSCALING *scaling);
...
cbRESULT cbGetAinpDisplay( UINT32 chan, INT32 *smpdispmin, INT32 *smpdispmax, INT32 *spkdispmax, INT32 *lncdispmax );
cbRESULT cbSetAinpDisplay( UINT32 chan, INT32  smpdispmin, INT32  smpdispmax, INT32  spkdispmax, INT32  lncdispmax );
...
cbRESULT cbSetAinpPreview(UINT32 chan, UINT32 prevopts);
...
cbRESULT cbGetAinpSampling(UINT32 chan, UINT32 *filter, UINT32 *group);
cbRESULT cbSetAinpSampling(UINT32 chan, UINT32 filter,  UINT32 group);
...
cbRESULT cbGetAinpSpikeCaps(UINT32 chan, UINT32 *flags);
cbRESULT cbGetAinpSpikeOptions(UINT32 chan, UINT32 *flags, UINT32 *filter);
cbRESULT cbSetAinpSpikeOptions(UINT32 chan, UINT32 flags,  UINT32 filter);
...
cbRESULT cbGetAinpSpikeThreshold(UINT32 chan, INT32 *level);
cbRESULT cbSetAinpSpikeThreshold(UINT32 chan, INT32 level);
...
cbRESULT cbGetAinpSpikeHoops(UINT32 chan, cbHOOP *hoops);
cbRESULT cbSetAinpSpikeHoops(UINT32 chan, cbHOOP *hoops);
...
cbRESULT cbGetAoutCaps( UINT32 chan, UINT32 *aoutcaps, cbSCALING *physcalout, cbFILTDESC *phyfiltout );
...
cbRESULT cbGetAoutScaling(UINT32 chan, cbSCALING *scaling);
cbRESULT cbSetAoutScaling(UINT32 chan, cbSCALING *scaling);
// Get/Set the user-specified scaling for the channel.  The digmin and digmax values of the user
// specified scaling must be within the digmin and digmax values for the physical channel mapping.
//
// Returns: cbRESULT_OK if data successfully retreived.
...
cbRESULT cbGetAoutOptions(UINT32 chan, UINT32 *options, UINT32 *monchan, UINT32 *value);
cbRESULT cbSetAoutOptions(UINT32 chan, UINT32 options, UINT32 monchan, UINT32 value);
...
cbRESULT cbGetSortingModel(void);
cbRESULT cbGetFeatureSpaceDomain(void);


// Getting and setting the noise boundary
cbRESULT cbSSGetNoiseBoundary(UINT32 chanIdx, float afCentroid[3], float afMajor[3], float afMinor_1[3], float afMinor_2[3]);
cbRESULT cbSSSetNoiseBoundary(UINT32 chanIdx, float afCentroid[3], float afMajor[3], float afMinor_1[3], float afMinor_2[3]);

cbRESULT cbSSGetNoiseBoundaryByTheta(UINT32 chanIdx, float afCentroid[3], float afAxisLen[3], float afTheta[3]);
cbRESULT cbSSSetNoiseBoundaryByTheta(UINT32 chanIdx, const float afCentroid[3], const float afAxisLen[3], const float afTheta[3]);
...
cbRESULT cbSSGetArtifactReject(UINT32 * pnMaxChans, UINT32 * pnRefractorySamples);
cbRESULT cbSSSetArtifactReject(UINT32 nMaxChans, UINT32 nRefractorySamples);

// Spike detection parameters
cbRESULT cbSSGetDetect(float * pfThreshold, float * pfScaling);
cbRESULT cbSSSetDetect(float fThreshold, float fScaling);
...
cbRESULT cbSSGetStatus(cbAdaptControl * pcntlUnitStats, cbAdaptControl * pcntlNumUnits);
cbRESULT cbSSSetStatus(cbAdaptControl cntlUnitStats, cbAdaptControl cntlNumUnits);
...
cbRESULT cbCheckforData(cbLevelOfConcern & nLevelOfConcern, UINT32 *pktstogo = NULL);
...
cbRESULT cbSendPacket(void * pPacket);
cbRESULT cbSendLoopbackPacket(void * pPacket);
...
#define cbNPLAY_FLAG_STEPPED         0x02  // NPLAY->PC step command done
...
typedef struct {
    ...
    // coords must be the last item in the structure because it can be variable length to a max of cbMAX_TRACKCOORDS
...
typedef struct {
    ...
    char   name[16];    // Computer name
    char   desc[2];     // description of the change (will fill the rest of the packet)
} cbPKT_LOG;
...
cbRESULT cbGetNTrodeInfo( const UINT32 ntrode, char *label, cbMANUALUNITMAPPING ellipses[][cbMAXUNITS], UINT16 * nSite, UINT16 * chans, UINT16 * fs);
cbRESULT cbSetNTrodeInfo( const UINT32 ntrode, const char *label, cbMANUALUNITMAPPING ellipses[][cbMAXUNITS], UINT16 fs);
...
struct cbPKT_UNIT_SELECTION
{
    ...
    WORD abyUnitSelections[cbMAXCHANS];     // one for each channel, channels are 0 based here
    ...
    cbPKT_UNIT_SELECTION(INT16 iLastchan) :
        chid(0x8000),
        type(TYPE_OUTGOING),
        lastchan(iLastchan)
    {
        ...
        _ASSERT(time != 0);     // send logic fails if time == 0
    }
...
typedef struct {
    ...
    void set(const char *szMapFilename)
    {
        ...
        strcpy_s(filename, sizeof(filename) - 1, szMapFilename);
    }
#endif
...
cbRESULT cbGetColorTable(cbCOLORTABLE **colortable);
...
float cbGetRMSAutoThresholdDistance(void);
void cbSetRMSAutoThresholdDistance(float fRMSAutoThresholdDistance);
...
cbRESULT cbGetSpkCache( UINT32 chid, cbSPKCACHE **cache );
...
public:
    ...
    BOOL SetWaveformFile(int nChannel, LPCTSTR filename, INT16 nLength)
    {
...
extern cbPcStatus * cb_pc_status_buffer_ptr;       // parameters dealing with local pc status
...
extern cbCFGBUFF * cb_cfg_buffer_ptr;
...
extern HANDLE      cb_xmt_global_buffer_hnd;       // Transmit queues to send out of this PC
extern cbXMTBUFF*  cb_xmt_global_buffer_ptr;

extern HANDLE      cb_xmt_local_buffer_hnd;        // Transmit queues only for local (this PC) use
extern cbXMTBUFF*  cb_xmt_local_buffer_ptr;

extern HANDLE       cb_rec_buffer_hnd;
extern cbRECBUFF*   cb_rec_buffer_ptr;
extern HANDLE       cb_cfg_buffer_hnd;
extern cbCFGBUFF*   cb_cfg_buffer_ptr;
extern HANDLE       cb_pc_status_buffer_hnd;
extern cbPcStatus*  cb_pc_status_buffer_ptr;
extern HANDLE       cb_spk_buffer_hnd;
extern cbSPKBUFF*   cb_spk_buffer_ptr;
extern HANDLE       cb_sig_event_hnd;

extern UINT32       cb_library_initialized;
