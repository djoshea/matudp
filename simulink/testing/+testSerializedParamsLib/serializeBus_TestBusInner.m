...
%   BusSerialize.writeSerializeBusModelPackagedCode('testSerializedParams', 'TestBusInner')

    valid = uint8(0);
    outSize = testSerializedParamsLib.getSerializedBusLength_TestBusInner(bus);
