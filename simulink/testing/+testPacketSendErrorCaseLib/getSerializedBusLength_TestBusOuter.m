...
%   writeGetSerializedBusLengthModelPackagedCode('testPacketSendErrorCase', 'TestBusOuter')
    ...
    % element nested
    outSize = outSize + uint16(testPacketSendErrorCaseLib.getSerializedBusLength_TestBusInner(bus.nested(1))); % for nested nested bus
