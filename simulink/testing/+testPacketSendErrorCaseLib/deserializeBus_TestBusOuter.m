...
%   writeDeserializeBusModelPackagedCode('testPacketSendErrorCase', 'TestBusOuter')
    ...
    [bus.nested, valid, offset] = testPacketSendErrorCaseLib.deserializeBus_TestBusInner(in, offset, valid);
