function [out, valid] = serializeBus_DataLoggerControlBus(bus)
%#codegen
% DO NOT EDIT: Auto-generated by 
%   BusSerialize.writeSerializeBusModelPackagedCode('testDataLoggerLocal', 'DataLoggerControlBus')

    valid = uint8(0);
    coder.varsize('out', 232);
    outSize = testDataLoggerLocalLib.getSerializedBusLength_DataLoggerControlBus(bus);
