...
%   writeGetSerializedBusLengthModelPackagedCode('testDataLoggerLocal', 'TestBusOuter')
    ...
    % element nested
    outSize = outSize + uint16(testDataLoggerLocalLib.getSerializedBusLength_TestBusInner(bus.nested(1))); % for nested nested bus
