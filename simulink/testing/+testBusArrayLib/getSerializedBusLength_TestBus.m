...
%   writeGetSerializedBusLengthModelPackagedCode('testBusArray', 'TestBus')
    ...
    outSize = outSize + uint16(numel(testBusArrayLib.enumToString_TestEnum(bus.enum))); % for enum enum to string
